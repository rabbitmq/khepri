...
%% tuple is made of:
%% <ol>
%% <li>A process alias ({@link erlang:alias/1}) designating the recipient of the
...
%% </ol></li>
%% <li>The result should be sent using {@link gen_server:reply/2}. The tuple is
%% of the form `{gen_server, From}'.</li>
%% </ul>
