...
api_behaviour_to_machine_version(extended_trigger)                  -> 3;
api_behaviour_to_machine_version(cached_members_list)               -> 3;
api_behaviour_to_machine_version(process_based_keep_while)          -> 3;
